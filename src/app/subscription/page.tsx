            ...
            <div className="max-w-2xl mx-auto px-4 sm:px-6">
                ...
                {cancelled && (
                    <motion.div
                        ...
                        animate={{ opacity: 1, y: 0 }}
                        className="mb-6 p-4 bg-neon-emerald/10 border border-neon-emerald/30 rounded-xl text-neon-emerald text-sm text-center"
                    >
                ...
                {hasActivePlan ? (
                    ...
                    <motion.div
                        ...
                        className="bg-dark-400 rounded-2xl border border-dark-50/30 overflow-hidden"
                    >
                        {/* Plan Header */}
                        <div className="p-6 bg-gradient-to-r from-primary-500/10 to-neon-violet/10 border-b border-dark-50/20">
                            <div className="flex items-center justify-between">
                                <div>
                                    <p className="text-xs text-slate-400 uppercase tracking-wider mb-1">Current Plan</p>
                                    <h2 className="text-2xl font-bold text-white">{subInfo!.planName}</h2>
                                </div>
                                <div className="text-right">
                                    <p className="text-3xl font-bold text-white">${subInfo!.price}</p>
                        ...
                        <div className="p-6 space-y-4">
                            <div className="grid grid-cols-2 gap-4">
                                <div className="bg-dark-600 rounded-xl p-4">
                                    ...
                                    <p className="text-sm font-medium text-white">{formatDate(subInfo!.startDate)}</p>
                                </div>
                                <div className="bg-dark-600 rounded-xl p-4">
                                    <p className="text-xs text-slate-400 mb-1">Renews On</p>
                                    <p className="text-sm font-medium text-white">{formatDate(subInfo!.endDate)}</p>
                                </div>
                            </div>
                            ...
                            <div className="bg-dark-600 rounded-xl p-4">
                                <div className="flex items-center justify-between mb-2">
                                    ...
                                    <p className="text-sm font-semibold text-white">{subInfo!.daysLeft} days left</p>
                                </div>
                                <div className="w-full h-2 bg-dark-300 rounded-full overflow-hidden">
                                    <motion.div
                                        ...
                                        className={`h-full rounded-full ${subInfo!.daysLeft > 10
                                            ? "bg-gradient-to-r from-neon-emerald to-teal-400"
                                            : subInfo!.daysLeft > 3
                            ...
                            {/* Features */}
                            <div className="bg-dark-600 rounded-xl p-4">
                                <p className="text-xs text-slate-400 mb-3">Included Features</p>
                            ...
                            <div className="flex flex-col sm:flex-row gap-3 pt-2">
                                {canUpgrade && (
                                    <Link
                                        href="/pricing"
                                        className="flex-1 py-3 text-center text-sm font-semibold text-white bg-gradient-to-r from-neon-blue to-primary-500 rounded-xl hover:shadow-lg hover:shadow-primary-500/25 hover:-translate-y-0.5 transition-all"
                                    >
                                        ⬆️ Upgrade Plan
                                    </Link>
                                )}
                                <button
                                    ...
                                    className="flex-1 py-3 text-center text-sm font-medium text-red-400 bg-red-500/10 border border-red-500/20 rounded-xl hover:bg-red-500/20 transition-all"
                                >
                                    Cancel Subscription
                                </button>
                            </div>
                    ...
                    <motion.div
                        ...
                        animate={{ opacity: 1, y: 0 }}
                        transition={{ delay: 0.1 }}
                        className="bg-dark-400 rounded-2xl p-8 border border-dark-50/30 text-center"
                    >
                        ...
                        <Link
                            href="/pricing"
                            className="inline-block px-8 py-3 text-sm font-semibold text-white bg-gradient-to-r from-neon-blue to-primary-500 rounded-xl hover:shadow-lg hover:shadow-primary-500/25 hover:-translate-y-0.5 transition-all"
                        >
                            🚀 View Plans
                        </Link>
                    </motion.div>
                ...
                <motion.div
                    ...
                    className="mt-8 bg-dark-400 rounded-2xl border border-dark-50/30 overflow-hidden"
                >
                    <div className="p-5 border-b border-dark-50/20">
                    ...
                    <div className="p-5">
                        {historyLoading ? (
                            ...
                            <p className="text-sm text-slate-500 text-center py-6">No subscription history yet.</p>
                        ) : (
                            <div className="space-y-3">
                                {history.map((p, i) => {
                                    ...
                                    return (
                                        <div
                                            key={i}
                                            className="flex items-center justify-between p-3 bg-dark-600 rounded-xl"
                                        >
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-xs text-slate-500">
                                                        {date}
                                                        {p.couponCode && (
                                                            <span className="ml-2 text-neon-emerald">🏷 {p.couponCode}</span>
                                                        )}
                                                    </p>
                                                </div>
                                            </div>
                                            <div className="text-right">
                                                ...
                                                <p className={`text-xs ${p.status === "paid" ? "text-neon-emerald" : "text-red-400"
                                                    }`}>
                    ...
                    {showCancelModal && (
                        ...
                        >
                            <motion.div
                                ...
                                className="bg-dark-400 rounded-2xl p-6 max-w-md w-full border border-dark-50/30 shadow-2xl"
                            >
                                <div className="text-center mb-6">
                                    <span className="text-4xl mb-3 block">⚠️</span>
                                    <h3 className="text-xl font-bold text-white mb-2">Cancel Subscription?</h3>
                                    <p className="text-sm text-slate-400">
                                        Are you sure you want to cancel your <strong className="text-white">{subInfo?.planName}</strong> plan? You&apos;ll lose access to all premium features immediately.
                                    </p>
                                </div>
                                ...
                                <div className="flex gap-3">
                                    <button
                                        ...
                                        className="flex-1 py-3 text-sm font-medium text-white bg-dark-200 rounded-xl hover:bg-dark-100 transition-all disabled:opacity-50"
                                    >
                                        Keep Plan
                                    </button>
                                    <button
                                        ...
                                        disabled={isCancelling}
                                        className="flex-1 py-3 text-sm font-semibold text-white bg-red-500 rounded-xl hover:bg-red-600 transition-all disabled:opacity-60"
                                    >
                                        {isCancelling ? (
