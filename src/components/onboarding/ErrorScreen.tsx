    ...
    return (
        ...
        >
            ...
            <div className="flex gap-3 justify-center">
                ...
                <button
                    onClick={onRetry}
                    className="px-6 py-3 text-sm font-bold text-white bg-gradient-to-r from-neon-blue to-primary-500 rounded-xl hover:shadow-lg hover:shadow-primary-500/30 transition-all"
                >
                    Retry ↻
                </button>
            </div>
