    ...
    return (
        ...
        >
            ...
            `,
                        ...
                        background: "linear-gradient(135deg, rgba(0,212,255,0.18), rgba(168,85,247,0.18), rgba(16,185,129,0.10))",
                        ...
                        textShadow: "0 0 12px rgba(0,212,255,0.4), 0 0 40px rgba(168,85,247,0.2)",
                        boxShadow: "0 0 30px rgba(0,212,255,0.12), 0 0 60px rgba(168,85,247,0.06), inset 0 0 30px rgba(255,255,255,0.04)",
